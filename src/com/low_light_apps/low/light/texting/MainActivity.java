...
public class MainActivity extends LowLightListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			setSmsMmsDataForLessThenJellyBean(cursor);
			setAdapter();
			...
			try {
				...
				if (cursor == null) {
					...
					mmsCursor = getContentResolver().query(
							Uri.parse("content://sms"), null, null, null, null);
					getSmsDataForJellyBean(smsCursor);
					setAdapter();
	...
	public void setSmsMmsDataForLessThenJellyBean(Cursor cursor) {
	...
	public void getSmsDataForJellyBean(Cursor cursor) {
